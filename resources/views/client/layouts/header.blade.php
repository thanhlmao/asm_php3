            ...
            <div class="container">
                <div class="row small-gutters">
                    ...
                    <nav class="col-xl-6 col-lg-7">
                        ...
                        <div class="main-menu">
                            <div id="header_menu">
                                <a href=""><img src="{{ asset('assets/img/logo_black.svg') }}" alt="" width="100" height="35"></a>
                            ...
                            <li>
                                <div class="dropdown dropdown-access">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @if(Auth::check())
                        <a class="phone_top text-center mb-2 fs-5"><strong><span>Xin chào :</span> {{ Auth::user()->name }}</strong></a>
                        <a href="{{ route('logout') }}" class="btn_1">Đăng xuất</a>
                    @else
                        <a class="phone_top" href="tel://9438843343"><strong><span>Need Help?</span>+94 423-23-221</strong></a>
                        <a href="{{ route('login') }}" class="btn_1">Đăng kí hoặc đăng nhập</a>
                    @endif
                                        <ul>
                                            <li>    
